...
//Get the info of all users
Route::get('/performance/get-users-filtrated', 'App\Http\Controllers\UsersController@GetMembersFiltrated');
...
Route::get('/get-performances-profit', 'App\Http\Controllers\PerformancesController@GetPerformancesByUserId');
//Get performance duties by user ID
